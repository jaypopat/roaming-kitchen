...
export default function Socials() {
  return (
    <div className="fixed top-1/2 right-0 transform -translate-y-1/2 z-50 flex flex-col items-end gap-2 px-4 py-2 bg-background shadow-lg rounded-l-lg">
      <a href="https://www.instagram.com/roamingkitchen_ie">
        <Button
          variant="ghost"
          size="icon"
      ...
      <a href="https://x.com/RoamingKitchen_">
        <Button
          variant="ghost"
          size="icon"
          className="text-muted-foreground hover:bg-muted/50 rounded-full"
      ...
      <a href="https://www.linkedin.com/company/roamingkitchen">
        <Button
          variant="ghost"
          size="icon"
          className="text-muted-foreground hover:bg-muted/50 rounded-full"
      ...
      <a href="https://www.github.com/jaypopat/roaming-kitchen">
        <Button
          variant="ghost"
          size="icon"
          className="text-muted-foreground hover:bg-muted/50 rounded-full"
